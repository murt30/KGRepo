...
<div id="product-modal" style="display:none;width:660px; max-width:600px; ">
<div style="border:solid red 1px;width:40%;float:left">1</div>
<div style="border:solid red 1px;width:50%;float:right">2</div>
 <div style="border:solid red 1px;">   <img id="product_image" src="" width="200px">
    <h2 id="title"></h2>
    <p id="description"></p>
    <h4 id="price"></h4>
